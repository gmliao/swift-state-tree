...
class DesignSystemGenerator:
    ...
    def _apply_reasoning(self, category: str, search_results: dict = None) -> dict:
        """Apply reasoning rules to search results."""
        # search_results parameter reserved for future use
        _ = search_results
    ...
    def _select_best_match(self, results: list, priority_keywords: list) -> dict:
        ...
        for priority in priority_keywords:
            ...
            for item in results:
                style_name = item.get("Style Category", "").lower()
