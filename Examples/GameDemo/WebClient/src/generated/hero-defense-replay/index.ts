...
import type { HeroDefenseReplayTickEvent, PlayerShootEvent, TurretFireEvent } from '../defs'
...
export class HeroDefenseReplayStateTree {
  ...
  /** Type-safe subscription for heroDefenseReplayTick server event */
  readonly heroDefenseReplayTick: EventSubscription<HeroDefenseReplayTickEvent>
  ...
  constructor(runtime: StateTreeRuntime, options?: StateTreeOptions) {
    ...
    this.on = {
      heroDefenseReplayTick: (handler) => this.view.onServerEvent("HeroDefenseReplayTick", handler),
    ...
    // Initialize heroDefenseReplayTick server event subscription
    this.heroDefenseReplayTick = {
      subscribe: (handler: EventHandler<HeroDefenseReplayTickEvent>) => {
        return this.view.onServerEvent("HeroDefenseReplayTick", handler)
      }
    } as EventSubscription<HeroDefenseReplayTickEvent>
