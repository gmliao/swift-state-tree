...
export class CounterStateTree {
  ...
  /** Type-safe method for increment action */
  readonly increment: (payload: IncrementAction) => Promise<IncrementResponse>
  ...
  constructor(runtime: StateTreeRuntime, options?: StateTreeOptions) {
    ...
    this.increment = (payload: IncrementAction) => {
      return this.view.sendAction("Increment", payload) as Promise<IncrementResponse>
    }
