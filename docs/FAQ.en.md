...
For detailed information, please refer to [Sync Rules](core/sync.en.md).
...
For detailed information, please refer to [Macros](macros/README.en.md).
...
For detailed information, please refer to [Transport Layer](transport/README.en.md).
...
For detailed information, please refer to [Authentication](hummingbird/auth.en.md).
...
- [Quick Start](quickstart.en.md) - Basic usage examples
- [Core Concepts](core/README.en.md) - Deep dive into system design
- [Sync Rules](core/sync.en.md) - Sync mechanism details
- [Land DSL](core/land-dsl.en.md) - Land definition guide
- [Transport Layer](transport/README.en.md) - Network transport details
