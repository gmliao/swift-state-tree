[English](resolver.en.md) | [中文版](resolver.md)
...
- [Runtime Operation](runtime.en.md) - Understand how LandKeeper executes resolvers
- [Core Concepts](README.en.md) - Understand StateNode and Land DSL
- [Land DSL](land-dsl.en.md) - Understand how to use resolvers in Land DSL
