[English](architecture.en.md) | [中文版](architecture.md)
...
**Related Documentation**:
- [Runtime Operation](core/runtime.en.md)
...
- [Overview](overview.en.md) - System overview
- [Runtime Operation](core/runtime.en.md) - LandKeeper detailed description
- [Transport Layer](transport/README.en.md) - Transport layer detailed description
